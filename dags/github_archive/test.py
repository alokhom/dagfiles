...
with DAG(dag_id="yajl_dag_new", start_date=pendulum.datetime(2024,11,0o7,tz="CET"), schedule_interval='@hourly', catchup=False) as dag:
       ...
       getfiles_jan = BashOperator(task_id="getfiles_jan",bash_command="curl -O https://data.gharchive.org/2024-01-01-23.json.gz")
       ...
       getfiles_feb = BashOperator(task_id="getfiles_feb",bash_command="curl -O https://data.gharchive.org/2024-02-01-23.json.gz")
       ...
       getfiles_mar = BashOperator(task_id="getfiles_mar",bash_command="curl -O https://data.gharchive.org/2024-03-01-23.json.gz")
