...
with DAG(dag_id="yajl_dag_new", start_date=pendulum.datetime(2024,11,0o7,tz="CET"), schedule_interval='@hourly', catchup=False) as dag:
       ...
       getfiles_jancheck = BashOperator(task_id="getfiles_jancheck",bash_command="ls -ltr /tmp/2024-01-01-23.json.gz && zcat /tmp/2024-01-01-23.json.gz > /tmp/2024-01-01-23_tmp.json && cat jq -c '.[]' /tmp/2024-01-01-23_tmp.json > /tmp/2024-01-01-23.json && echo {'name': 'alok'} > /tmp/test.json && sleep 10")
       ...
       getfiles_jan >> getfiles_jancheck >> create_table >> getfiles_feb >> getfiles_mar 
