...
with DAG(dag_id="yajl_dag_new", start_date=pendulum.datetime(2024,11,0o7,tz="CET"), schedule_interval='@hourly', catchup=False) as dag:
       ...
       # january 
       getfiles_jan = PythonOperator(task_id="getfiles_jan", python_callable=my_func, op_args=['https://data.gharchive.org/2024-01-01-{21..23}.json.gz'])
       getfiles_jancheck = BashOperator(task_id="getfiles_jancheck",bash_command="[[ -f /tmp/2024-01-01-{21..23}.json.gz ]] && echo 'File found!' && ls -ltr /tmp/2024-01-01-{21..23}.json.gz && gunzip -c /tmp/2024-01-01-{21..23}.json.gz >/tmp/2024-01-01-{21..23}.json")
